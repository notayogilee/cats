...
const breedDetails = function (breed) {
  ...
  if (catBreeds[breed] === undefined) {
    return "Sorry, I have no info on that breed of cat!";
  }
  // console.log(catBreeds['Bombay']);
  return catBreeds[breed];
};

// get the return value right away from the function
// const bombay = breedDetails('Bombay');
console.log(breedDetails('Bombay')); //=> prints out the description for that breed
console.log(breedDetails('Balinese'));
console.log(breedDetails('Stray'));
